                 ...
                 <div class="panel panel-default">
                     ...
                     <div class="panel-body">
                         <div class="panel panel-default panel-light" id="cpi">
                             <label  class="panel-heading" style="display: block;border-bottom: 1px solid var(--border-color);"><input type="radio" name="__wpdm_cpage_style"  <?php checked(get_option('__wpdm_cpage_style'),'basic'); ?> value="basic"> <?php echo __( "Do Not Apply", "download-manager" ) ?></label>
                             <div class="panel-body">
                 ...
                 include dirname(__FILE__).'/user-signup.php';
                 ?>
