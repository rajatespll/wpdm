    ...
    <form method="post" id="emlstform">
        ...
        <div class="panel panel-default">
            <div class="panel-heading">
                <div class="pull-right"><button class="btn btn-info btn-sm" type="button" id="testsend" style="margin-top: -3px"><?php _e('Send Test Email', WPDM_TEXT_DOMAIN); ?></button></div>
                <?php _e('Email Settings', WPDM_TEXT_DOMAIN); ?>
            </div>
                ...
                <div class="row">
                    <div class="col-md-4">
                        ...
                        <div class="form-group">
                            ...
                            <div class="xbubble" style="margin-top: 5px;box-shadow: none;z-index: 999;cursor: pointer">
