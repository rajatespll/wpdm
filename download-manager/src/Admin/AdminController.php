...
class AdminController {
    ...
    function registerScripts(){
        ...
        //wp_register_script('wpdm-admin-bootstrap', WPDM_BASE_URL.'assets/adminui/js/bootstrap.bundle.min.js', array('jquery'));
        wp_register_style('wpdm-admin-base', WPDM_BASE_URL.'assets/adminui/css/base.min.css');
    ...
    function enqueueScripts() {
        ...
        global $pagenow;
        $allow_bscss = array('profile.php', 'user-edit.php',  'upload.php', 'users.php');
    ...
    function notices()
    {
	    ...
	    if (is_admin() && current_user_can('manage_options') && Installer::dbUpdateRequired()) {
		    ...
		    printf('<div id="wpdmvnotice" class="notice notice-warning  is-dismissible w3eden"><div class="media" style="padding: 20px;line-height: 22px"><div class="ml-3 pull-right"><a class="btn btn-primary btn-sm" href="%2$s">Update Database</a></div><div class="media-body">%1$s</div></div></div>', $message, admin_url('edit.php?post_type=wpdmpro&page=settings'));
	    }
    }
