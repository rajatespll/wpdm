            ...
            <div class="panel panel-default card-plain panel-plain">
                ...
                <div class="panel-body">
                    <div class="panel panel-default panel-light" id="cpi">
                        <label  class="panel-heading" style="display: block;border-bottom: 1px solid var(--border-color);margin-bottom: -1px"><input type="radio" name="__wpdmcategory[style]"  checked="checked" value="global"> <?php echo __( "Use Global", "download-manager" ) ?></label>
                ...
                <?php if(!file_exists(get_stylesheet_directory().'/taxonomy-wpdmcategory.php') && !file_exists(get_template_directory().'/taxonomy-wpdmcategory.php')){
                    ...
                    <div class="form-field w3eden">
                        <div class="panel panel-default card-plain panel-plain">
                            ...
                            <div class="panel-body">
                                <div class="panel panel-default panel-light" id="cpi">
                                    <label  class="panel-heading" style="display: block;border-bottom: 1px solid var(--border-color);;margin-bottom: -1px"><input type="radio" name="__wpdmcategory[style]"  <?php checked($style,'global'); ?> value="global"> <?php echo __( "Use Global", "download-manager" ) ?></label>
