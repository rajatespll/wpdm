...
?>
    ...
    <head>
        ...
        <title><?php _e('Asset Manager Picker', 'download-manager') ?></title>
            ...
            <link rel="stylesheet" href="<?php echo WPDM_BASE_URL; ?>assets/adminui/css/base.css" />
                                ...
                                <div class="panel-body">
                                    <div class="media well-sm well-file" style="margin: 0;padding: 0">
                                        <div class="pull-right">
                                            <!--
                                            <input style="width: 150px;display: inline-block" type="text" class="form-control input-sm" id="__wpdm_filesearch" placeholder="<?php /*= esc_attr__( 'Search File...', WPDM_TEXT_DOMAIN ); */?>" />
                                            -->
                                            <span id="__file_search"><input  v-on:keyup.enter="searchAsset.execute()" id="__wpdm_filesearch" type="search" v-model="keyword" placeholder="Search File..." class="form-control input-sm" style="font-family: 'Overpass Mono', monospace;width: 140px;display: inline-block;"></span>
