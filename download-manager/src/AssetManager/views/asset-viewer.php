...
<html lang="en">
        ...
        <style>
            ...
            *, *:before, *:after {
            ...
            .blockui:before{
                ...
                top: 0;
                z-index: 1;
                background: rgba(255, 255, 255, 0.8) url("<?= WPDM_ASSET_URL ?>images/loader.svg") center center no-repeat;
    ...
    <body>
        ...
        <div id="mySidenav" class="sidenav">
            <a href="javascript:void(0)" class="open-close-btn" onclick="toggleNav()">
	            <svg height="24px" version="1.1" viewBox="0 0 24 24" width="24px" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"><title/><desc/><g fill="none" fill-rule="evenodd" id="info" stroke="none" stroke-width="1"><g id="Icon-Go-Copy-11" transform="translate(10.000000, 5.000000)"><g id="Arrow" transform="translate(0.750000, 0.750000)"><line id="Line-6" stroke="#2E308A" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" x1="1.25" x2="1.25" y1="5" y2="10"/><circle cx="1.25" cy="1.25" fill="#2E308A" id="Oval" r="1.25"/></g></g><g id="Group" transform="translate(2.000000, 2.000000)"><path d="M1.47709815,4.76661369 C0.540320856,6.28896748 0,8.08138439 0,10 C0,15.5228475 4.4771525,20 10,20 C15.5228475,20 20,15.5228475 20,10 C20,4.4771525 15.5228475,0 10,0 C9.20450662,0 8.43070787,0.0928857134 7.68885787,0.268403002" id="Path" stroke="#2E308A" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"/><circle cx="4" cy="2" fill="#2E308A" id="Oval" r="1"/></g></g></svg>
            </a>
            <!-- Tabs -->
            ...
            <div class="tab-content">
                ...
                <div data-target="tab-a" class="tab tab--active">
                    <?php if(is_user_logged_in()){ ?>
                    <form id="cmfrm" action="">
                        <input id="commentcont" type="text" placeholder="Comment here..">

                        <svg id="newcomment" onclick="jQuery('#cmfrm').submit();" class="submit nav-svg arrow color-gray" enable-background="new 0 0 485.808 485.808" version="1.1" viewBox="0 0 485.81 485.81" xml:space="preserve" xmlns="http://www.w3.org/2000/svg">
