                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-<?php echo $ob; ?> col-md-4">
                            <select name="orderby" class="wpdm-custom-select custom-select">
                                ...
                                <option value="downloads" <?php selected('download_count', wpdm_query_var('orderby')) ?>><?php echo __( "Downloads", "download-manager" ) ?></option>
                                <option value="views" <?php selected('view_count', wpdm_query_var('orderby')) ?>><?php echo __( "Views", "download-manager" ) ?></option>
                            </select>
                        </div>
