<div class="card "
    ...
    <div class="card-body-set">
        ...
        <div id="package-settings" class="tab-pane active">
            ...
            <?php include \WPDM\__\Template::locate('author-dashboard/new-package-form/lock-options.php', dirname(dirname(__DIR__))); ?>
            <?php include \WPDM\__\Template::locate('author-dashboard/new-package-form/icons.php', dirname(dirname(__DIR__))); ?>
...
<script type="text/javascript">
    ...
    jQuery(document).ready(function() {
        ...
        jQuery("#wpdm-settings select").select2({no_results_text: "", minimumResultsForSearch: 6});
